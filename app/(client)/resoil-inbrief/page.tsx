...
export default function ResoilInbrief() {
    ...
    <div className="container mx-auto px-6 md:px-16 lg:px-24 py-10">
      ...
      <section className="flex flex-col md:flex-row gap-10 mb-10">
        <div className="md:w-1/2">
          <h2 className="text-lg font-bold mb-4">What we can treat with ReSoil® technology</h2>
          <p>
        ...
        <div className="md:w-1/2">
          <h2 className="text-lg font-bold mb-4">What we cannot treat with ReSoil® technology</h2>
          <p>
  ...
  <div className="p-6 border rounded-lg shadow-md">
    <Link href="/technology-description">
      <h3 className="text-md font-bold mb-2 text-blue-500 hover:underline">Technology description</h3>
    </Link>
    <p className="mb-4">
  ...
  <div className="p-6 border rounded-lg shadow-md">
    <Link href="/case-studies">
      <h3 className="text-md font-bold mb-2 text-blue-500 hover:underline">Case study</h3>
    </Link>
    <p className="mb-4">
  ...
  <div className="p-6 border rounded-lg shadow-md">
    <Link href="/faq">
      <h3 className="text-md font-bold mb-2 text-blue-500 hover:underline">FAQ</h3>
    </Link>
    <p className="mb-4">
      Is ReSoil® technology limited to removal of Pb from contaminated soils? <br />
